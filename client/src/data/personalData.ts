...
export const personalData = {
    ...
    soft: [
      {
        ...
        description: "Creative approach to solving coding challenges",
      },
      {
        name: "Communication",
      ...
      },
      {
        ...
        description: "Balancing school and programming projects effectively",
      },
    ],
  },
  ...
  techStack: [
    {
      ...
      description: "Languages and frameworks I use to ship full-stack applications.",
      icon: "Laptop",
      items: [
        "TypeScript",
        "JavaScript (ES6+)",
    ...
    },
    {
      ...
      description: "Interface libraries, design systems, and interaction patterns.",
      icon: "Palette",
      items: [
        "shadcn/ui",
        "Radix UI",
    ...
    {
      title: "Backend, Auth & Integrations",
      description: "APIs, authentication, and service integrations that power projects.",
      icon: "ServerCog",
      items: [
        "Express.js REST APIs",
        "PHP (InfinityFree endpoints, mail)",
        "Flask (Python backend)",
        "WebSockets (ws)",
        "Gunicorn (Python production server)",
        "Supabase (Postgres, Auth, REST API, Edge Functions)",
        ...
        "Drizzle ORM (Type-safe schema layer)",
        "Drizzle Kit (schema and migrations)",
        "PHPMailer",
        "Nodemailer",
        "@sendgrid/mail",
        "Web3Forms",
    ...
    {
      title: "Data & Media Automation",
      description: "Pipelines for AI, computer vision, and document processing.",
      icon: "BrainCircuit",
      items: [
        "numpy",
        "pandas",
    ...
    },
    {
      ...
      description: "Build tools, package managers, and testing utilities I rely on daily.",
      icon: "Wrench",
      items: [
    ...
    },
    {
      ...
      description: "Hosting, orchestration, and delivery platforms for shipping products.",
      icon: "Cloud",
      items: [
        "Docker",
        "docker-compose",
        "Docker multi-stage builds (React + Flask app)",
        "Render (Node.js web service)",
        "InfinityFree (PHP/JS hybrid hosting)",
        "Neon Serverless PostgreSQL",
        "MySQL (InfinityFree hosting)",
        "GitHub Pages (static asset hosting)",
        "NPM registry (package distribution)",
        "JSON file storage (local persistence and backups)",
      ],
    },
    {
      title: "Game Development & Pipelines",
      description: "Tools for building immersive interactive and media-rich experiences.",
      icon: "Gamepad2",
      items: [
        "GameMaker Studio 2 (2024.11.0.179 IDE & runtime engine)",
        "GML (GameMaker Language)",
        "GML scripting for player logic, camera control, animations, and event handling",
        "GameMaker Studio 2 runtime engine",
        "Windows exporter",
        "Node-based SVG to PNG conversion pipeline (svgexport, imagemin-cli)",
      ],
    },
    {
      title: "Operational Insights & Utilities",
      description: "Supporting libraries that keep apps observable and data-rich.",
      icon: "Radar",
      items: [
        "geoip-lite (visitor tracking and analytics)",
        "Health and status endpoints (Next.js, Flask)",
        "Supabase (Database, Auth, Storage, Edge Functions)",
        "JSON metadata tools (countries.json, flags.json)",
      ],
    },
  ],
  ...
  volunteerWork: [
    {
      organization: "Panchgani Education Initiative",
      role: "Volunteer",
      period: "Annual Event",
      description:
