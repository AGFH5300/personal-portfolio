      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Run and interact with my coding projects directly in your browser. Click on difficulty or category badges to filter projects. If the code asks for <strong>y or n</strong>, this means <strong>yes or no</strong>.
          </p>
