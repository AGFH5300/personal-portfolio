...
import { 
  Users, MessageSquare, Lightbulb, ListTodo
} from "lucide-react";
  ...
  return (
    <section id="skills" className="py-16 bg-white" ref={sectionRef}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-dark mb-4">Skills & Expertise</h2>
              ...
              {personalData.skills.soft.map((skill, index) => (
                ...
                >
                  <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    {skillIcons[skill.name as keyof typeof skillIcons] || <Lightbulb className="text-primary text-xl" />}
                  </div>
        ...
        <div className="mt-16">
          <motion.div 
            ...
            transition={{ duration: 0.5 }}
          >
            <h3 className="text-2xl font-bold text-dark mb-4">Certifications & Achievements</h3>
            <div className="w-20 h-1 bg-accent mx-auto"></div>
          </motion.div>
                ...
                <div className="relative overflow-hidden" style={{ height: '200px' }}>
                  ...
                  >
                    <div className="absolute inset-0 bg-black/5 hover:bg-black/20 transition-colors flex items-center justify-center">
                      <span className="bg-white/90 text-primary text-xs px-2 py-1 rounded">View Certificate</span>
                    </div>
                    <img 
                      src={cert.image} 
                      alt={cert.name} 
